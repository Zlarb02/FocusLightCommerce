...
export class MemStorage implements IStorage {
  ...
  // Une méthode d'initialisation pour suivre le même format que PgStorage
  async initDatabase() {
    // Rien à initialiser pour le stockage en mémoire, c'est déjà fait dans le constructeur
    return;
  }
