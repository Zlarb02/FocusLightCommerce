    ...
    <>
      ...
      {comingFromLanding && (
        <button
          ...
          className="fixed top-4 left-4 z-50 flex items-center gap-1 bg-white/80 backdrop-blur-sm px-3 py-2 rounded-md text-sm shadow-sm hover:bg-white transition-all"
