        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <Link href="/">
            <a className="flex items-center">
              <img src="/src/assets/logo.png" alt="FOCUS" className="h-10 w-auto" />
            </a>
          </Link>
          
          <nav className="hidden md:flex space-x-8">
            <Link href="/">
              <a className={`font-medium ${location === "/" ? "text-primary" : "text-dark hover:text-primary-foreground/80 transition"}`}>
                Accueil
              </a>
            </Link>
            <a href="#product-details" className="font-medium text-dark hover:text-muted-foreground transition">
              Produits
            </a>
            <a href="#" className="font-medium text-dark hover:text-muted-foreground transition">
              À propos
            </a>
            <a href="#" className="font-medium text-dark hover:text-muted-foreground transition">
              Contact
              ...
              <SheetContent side="right">
                <div className="flex flex-col h-full pt-6">
                  <nav className="flex flex-col space-y-4">
                    <Link href="/">
                      <a className={`font-medium px-2 py-2 ${location === "/" ? "text-primary" : "text-dark"}`}>
                        Accueil
                      </a>
                    </Link>
                    <a href="#product-details" className="font-medium px-2 py-2">
                      Produits
                    </a>
                    ...
                    <Link href="/admin/login">
                      <a className="font-medium px-2 py-2 text-muted-foreground">
                        Administration
                      </a>
                    </Link>
                  </nav>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Illuminez votre intérieur avec notre concept de lampe écologique et design, fabriquée en France.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="#" className="text-gray-400 hover:text-white transition">FOCUS.01</a>
                </li>
                <li>
                  <a href="#" className="text-gray-400 hover:text-white transition">Nouveautés</a>
                </li>
                <li>
                  <a href="#" className="text-gray-400 hover:text-white transition">Meilleures ventes</a>
                </li>
                <li>
                  <a href="#" className="text-gray-400 hover:text-white transition">Éditions limitées</a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="#" className="text-gray-400 hover:text-white transition">Livraison</a>
                </li>
                <li>
                  <a href="#" className="text-gray-400 hover:text-white transition">Retours</a>
                </li>
                <li>
                  <a href="#" className="text-gray-400 hover:text-white transition">Garantie</a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  <svg className="h-5 w-5 text-gray-400 mt-1 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-400">12 rue des Luminaires<br />75011 Paris, France</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">&copy; 2023 FOCUS. Tous droits réservés.</p>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="#" className="text-gray-400 hover:text-white text-sm transition">CGV</a>
            </div>
            
            <div className="flex gap-2 mt-4 md:mt-0">
              <svg className="h-8 w-auto opacity-70" viewBox="0 0 576 512" fill="currentColor">
              ...
              <svg className="h-8 w-auto opacity-70" viewBox="0 0 640 512" fill="currentColor">
