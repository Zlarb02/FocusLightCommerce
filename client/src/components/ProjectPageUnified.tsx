  ...
  return (
    <ProjectLayoutUnified title={title} currentProject={currentProject}>
      ...
      <article className="max-w-4xl mx-auto">
        <header className="mb-16 text-center border-b border-gray-200 dark:border-gray-700 pb-12">
          <div className="mb-6">
            {date && (
              <time className="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                {date}
              </time>
            )}
          </div>
          <h1
            className="text-5xl md:text-6xl font-bold mb-6 leading-tight text-gray-900 dark:text-gray-100"
            style={{ fontFamily: "var(--font-titles)" }}
          >
            {title}
          </h1>
          {subtitle && (
            <p className="text-2xl text-gray-600 dark:text-gray-400 font-light leading-relaxed max-w-3xl mx-auto">
              {subtitle}
            </p>
          )}
        </header>
        ...
        <figure className="mb-16 flex justify-center">
          <div className="relative group">
            <div className="bg-white dark:bg-gray-800 p-6 shadow-2xl max-w-4xl w-full transform transition-all duration-500 hover:scale-[1.02] hover:shadow-3xl">
              <img
                src={imagePath}
                alt={title}
              ...
              <div className="h-16 flex items-center justify-center">
                <figcaption className="text-sm text-gray-400 dark:text-gray-500 font-medium tracking-wide">
                  {title}
                </figcaption>
              </div>
            </div>
        ...
        <section className="prose prose-xl max-w-none mx-auto mb-16">
          <div className="text-gray-800 dark:text-gray-200 leading-[1.8] font-light text-xl space-y-6">
        ...
        <figure className="mb-16 flex justify-center">
          <div className="relative">
            <div className="bg-white dark:bg-gray-800 p-4 shadow-lg max-w-2xl w-full transform transition-all duration-300 hover:scale-[1.01]">
              <img
                src={imagePath}
        ...
        {additionalContent && (
          <section className="mb-16">
            <div className="prose prose-xl max-w-none mx-auto text-gray-800 dark:text-gray-200 leading-relaxed">
              {additionalContent}
            </div>
            ...
            <figure className="mt-12 flex justify-center">
              <div className="relative">
                <div className="bg-white dark:bg-gray-800 p-4 shadow-lg max-w-3xl w-full transform transition-all duration-300 hover:scale-[1.01]">
                  <img
                    src={imagePath}
