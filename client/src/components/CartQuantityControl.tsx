    ...
    >
      ...
      <div className="flex items-center justify-center gap-4">
        <Button
          ...
          variant="outline"
          size="sm"
          className="h-10 w-10 p-0 rounded-full border-2 hover:bg-red-50 hover:border-red-300"
        >
        ...
        <Button
          ...
          variant="outline"
          size="sm"
          className="h-10 w-10 p-0 rounded-full border-2 hover:bg-green-50 hover:border-green-300"
