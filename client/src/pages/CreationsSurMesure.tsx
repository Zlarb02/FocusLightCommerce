  ...
  const customCreations = [
    {
      ...
      description: "Applique murale sur mesure avec éclairage LED indirect, créée pour un projet d'architecture d'intérieur contemporain.",
      ...
      specs: "Dimensions : 40x20x15cm • Puissance : 15W LED • Température : 2700K-4000K",
      price: "Sur devis"
    },
    {
      id: "lampe-bras-articule",
      title: "Lampe à Bras Articulé",
      description: "Luminaire mural avec bras articulé pour un espace de travail, offrant une flexibilité maximale d'éclairage.",
      ...
      specs: "Portée : 80cm • Rotation : 360° • Puissance : 12W LED • Gradation tactile",
      price: "Sur devis"
    },
    {
      id: "lampadaire-design",
      title: "Lampadaire Design Contemporain",
      description: "Lampadaire sur mesure alliant esthétique moderne et fonctionnalité, créé pour un salon d'entreprise.",
      ...
      specs: "Hauteur : 150-180cm • Double flux LED • Base Ø30cm • Finition naturelle",
      price: "Sur devis"
    },
    {
      id: "lampadaire-sculptural",
      title: "Lampadaire Sculptural",
      description: "Pièce unique sculptée dans du chêne massif, fusionnant art et éclairage pour un hall d'accueil.",
      ...
      specs: "Hauteur : 200cm • Éclairage ambiant 360° • Socle intégré • Pièce unique",
      price: "Sur devis"
    }
  ];
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
            <div className="text-center">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-6">
                Créations à la <span className="text-amber-600 dark:text-amber-400">Demande</span>
              </h1>
              <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
                Des luminaires uniques conçus spécialement pour vos projets d'architecture et d'aménagement
              </p>
              <div className="flex items-center justify-center gap-2 text-amber-600 dark:text-amber-400 mb-6">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="h-5 w-5 fill-current" />
                ))}
                <span className="ml-2 text-gray-600 dark:text-gray-300">Créations 100% sur mesure</span>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                Découvrez quelques-unes de nos créations sur mesure réalisées pour des clients exigeants
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button
                ...
                onClick={() => window.location.href = "mailto:altolille@gmail.com?subject=Demande de devis - Création sur mesure"}
              >
            ...
            <div className="mt-8 pt-8 border-t border-amber-500/30">
              <p className="text-amber-100 text-sm">
                <strong>Délai de réalisation :</strong> 3 à 6 semaines selon la complexité du projet<br/>
                <strong>Garantie :</strong> 2 ans sur tous nos luminaires sur mesure
              </p>
            </div>
          </div>
        </section>
