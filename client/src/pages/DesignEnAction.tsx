          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
            <div className="text-center">
              ...
              <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto mb-8 leading-relaxed">
                Projets qui questionnent nos habitudes et proposent des
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  <div className="p-8 lg:p-12 flex flex-col justify-center">
                    ...
                    <div className="prose prose-lg dark:prose-invert mb-8">
                      <p>
                        Sea-clé est un projet de diplôme conçu pour
                        révolutionner le ramassage des déchets plastiques sur
                        les plages de sable. Cet outil innovant permet aux
                        associations environnementales de collecter efficacement
                        les détritus sans effort physique excessif.
                      </p>
                    </div>
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/30 p-6 rounded-lg mb-8">
                      ...
                      <p className="text-gray-700 dark:text-gray-300">
                        Fabriqué par PLASTICEM à partir des déchets plastiques
                        récupérés sur les plages, Sea-clé incarne parfaitement
                        l'économie circulaire : transformer le problème en
                        solution.
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-400">
                      <div>
                        <strong>Fabricant :</strong> PLASTICEM
                      </div>
                      <div>
                        <strong>Matériau :</strong> Plastique recyclé
                      </div>
                      <div>
                        <strong>Dimensions :</strong> 90 x 30 x 90 cm
                      </div>
                      <div>
                        <strong>Usage :</strong> Associations
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  ...
                  <div className="p-8 lg:p-12 flex flex-col justify-center lg:order-2">
                    ...
                    <div className="prose prose-lg dark:prose-invert mb-8">
                      <p>
                        Without speaker est un lecteur vinyle qui permet
                        d'utiliser le moins d'énergie possible. Le son est créé
                        grâce à la vibration du diamant sur le vinyle, amplifiée
                        naturellement par la caisse de résonance.
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-900 dark:bg-gray-700 text-white p-6 rounded-lg mb-8">
                      ...
                      <p className="text-gray-200">
                        Face à la complexification constante de nos objets, ce
                        projet propose un retour à l'essentiel. Aucune
                        électronique, juste la pure mécanique au service de la
                        musique.
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-400">
                      <div>
                        <strong>Type :</strong> Low-tech
                      </div>
                      <div>
                        <strong>Principe :</strong> Amplification naturelle
                      </div>
                      <div>
                        <strong>Année :</strong> 2022
                      </div>
                      <div>
                        <strong>Fonctionnement :</strong> Vibration mécanique
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="bg-gray-50 dark:bg-gray-800 py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-12 leading-relaxed">
              Nos projets "Design en action" illustrent notre engagement pour un
              design responsable et innovant. Chaque création questionne nos
              habitudes et propose des alternatives durables.
            </p>
